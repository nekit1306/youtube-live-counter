...
const TypeComments=({activeType})=>(
    <span className="type-icon ">
        <svg width="29px" height="29px" viewBox="0 0 254.782 254.782">
            <g>
                ...
                c-2.672-33.196,36.268-59.115,37.318-74.839c-0.047-14.875-2.589-26.581-7.045-35.688C112.593-2.032,63.408,3.499,23.384,30.344z" fill="#FFFFFF"/>
                ...
                c-1.279-12.903,1.737-26.252,8.585-37.016C133.2,110.81,141.104,103.859,151.204,100.091z" fill="#FFFFFF"/>
            </g>
        </svg>
    </span>
);
